...
<html lang="en">
  ...
  <body background="https://th.bing.com/th/id/OIP.L2SUcC2c4dQw72td0j_1_AAAAA?pid=ImgDet&w=314&h=300&rs=1">
  <?php
  include 'navbar.php';
  ?>
      <div class="container-fluid">
            <div class="row intro py-1">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img class="im" src="img/s.png" class="img-fluid pt-2">
              </div>
      ...
      <footer class="text-center mt-5 py-2">
        <p>A Project by <b>Santhosh S</b> <br> </p>
      </footer>
